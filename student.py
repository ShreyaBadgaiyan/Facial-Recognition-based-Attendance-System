...
#bg image
     ...
     #    gender_entry.grid(row=2,column=1,padx=10,pady=5,sticky=W)
        ...
        gender_combo["values"]=("Select Gender","Female","Male","Prefer not say")
     ...
     #    update_btn=Button(btn_frame,text="Update",width=17,font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        img_right=Image.open(r"D:\Desktop\Computer Science\Facial Recognition based attendance system\collect_images\college.jpg")
