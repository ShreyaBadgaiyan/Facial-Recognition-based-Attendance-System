...
class Attendance:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"collect_images\attendance.jpg")
...
#second image
        ...
        img1=Image.open(r"collect_images\student.jpg")
...
#bg image
        img3=Image.open(r"collect_images\bg_img.jpg")
        img3=img3.resize((1530,710),Image.LANCZOS)
        self.photoimg3=ImageTk.PhotoImage(img3)

        bgimg=Label(self.root,image=self.photoimg3)
        bgimg.place(x=0,y=200,width=1530,height=710)

        title_lbl=Label(bgimg,text="ATTENDANCE MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="white",fg="darkgreen")
        ...
        img_left=Image.open(r"D:\Desktop\Computer Science\Facial Recognition based attendance system\collect_images\college.jpg")
        ...
        update_btn = Button(btn_frame,text="Export csv",bg="Blue",fg="White",width=17,font=("times new roman",12,"bold" ))
