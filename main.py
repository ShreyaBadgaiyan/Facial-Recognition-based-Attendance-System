...
#detect face button
        ...
        b1=Button(bgimg,image=self.photoimg5,cursor="hand2")  
        b1.place(x=500,y=100,width=220,height=220)

        b1=Button(bgimg,text="Face Detector",cursor="hand2",font=("times new roman",15,"bold"),bg="darkblue",fg="white")  
...
#Help desk button
        ...
        b1=Button(bgimg,image=self.photoimg8,cursor="hand2")  
        b1.place(x=200,y=380,width=220,height=220)

        b1=Button(bgimg,text="Train Data",cursor="hand2",font=("times new roman",15,"bold"),bg="darkblue",fg="white")  
        ...
        b1=Button(bgimg,image=self.photoimg9,cursor="hand2")  
        b1.place(x=500,y=380,width=220,height=220)

        b1=Button(bgimg,text="Photos",cursor="hand2",font=("times new roman",15,"bold"),bg="darkblue",fg="white")  
